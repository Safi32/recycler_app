  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (uid != null) {
        ...
        final savedRole = (doc.data() ?? const {})['role']?.toString().toLowerCase();
      ...
      Get.snackbar('Login failed', e.message ?? e.code, snackPosition: SnackPosition.BOTTOM);
    } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('Create an account', style: theme.textTheme.bodyMedium),
                  )
                ],
              ),
            ),
